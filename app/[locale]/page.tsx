    ...
    <main dir={isRTL ? 'rtl' : 'ltr'} className="main">
      ...
      <section className="stats-section">
        <div className="container">
          <p className="stats-tagline">
            {isRTL ? (
              <>أخصائية تغذية علاجية ومدربة صحة معتمدة، بخبرة في مساعدة أكثر من <span style={{ fontWeight: 700 }}>٨٩٦</span> سيدة في تحقيق أهدافهم الصحية</>
            ) : (
              <>A certified clinical nutritionist and health coach with experience helping over <span style={{ fontWeight: 700 }}>896</span> women achieve their health goals</>
            )}
          </p>
        ...
        <div className="container">
          ...
          <div className="slider-container">
            ...
            <div className="slider-controls">
              <button className={`slider-btn ${isRTL ? 'next' : 'prev'}`} aria-label="Previous">‹</button>
              <div className="slider-dots" />
              <button className={`slider-btn ${isRTL ? 'prev' : 'next'}`} aria-label="Next">›</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta" id="book">
        <div className="container cta-container">
          ...
          <a href={`/${locale}/contact#book`} className="btn-primary cta-button">{t('cta.button_text')}</a>
        </div>
      </section>
